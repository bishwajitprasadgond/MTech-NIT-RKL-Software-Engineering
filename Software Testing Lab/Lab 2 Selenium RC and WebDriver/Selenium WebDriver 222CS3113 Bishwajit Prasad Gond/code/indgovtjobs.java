...
public class indgovtjobs {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\BISHU\\Downloads\\seleniumwebdriver\\chromedriver.exe");
		  ...
		  dv1.get("https://www.indgovtjobs.in/");
		  dv1.findElement(By.name("search")).sendKeys("ISRO");
		  dv1.findElement(By.className("gsc-search-button-v2")).click();
